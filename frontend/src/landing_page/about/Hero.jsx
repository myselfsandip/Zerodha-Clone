    ...
    return (
        <div className="container p-5 mb-3">
            <div className="row text-center">
                <h2 className="mt-5 mb-5" style={{fontSize:"2rem",lineHeight:"1.5"}}>We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.</h2>
            </div>
            <div className="row m-5 border-top justify-content-center">
                <div className="col-6 mt-5 p-5 text-muted" style={{fontSize:"17px" , lineHeight:"1.5"}}>
